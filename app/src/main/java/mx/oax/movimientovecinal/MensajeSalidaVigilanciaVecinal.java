...
public class MensajeSalidaVigilanciaVecinal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mensaje_salida_vigilancia_vecinal);

        btnHome = findViewById(R.id.imgHomeViolenciaMensaje);
        btn911 = findViewById(R.id.img911Vigilancia);

        btnHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(MensajeSalidaVigilanciaVecinal.this,MenuEventos.class);
                startActivity(i);
            }
        });
